...
//数据库查询功能
public class Query {
	public static void updateOrderState(String ordernumber){
	...
	public static void deleteBookedOrder(String ordernumber){
		Connection connection = null;
		Statement preparedStatement = null;
		try{
			connection =  DataBase.getConnection();
	...
	public static void updateRoomPrice(String roomType,String newprice){
		Connection connection = null;
		Statement preparedStatement = null;
		try{
			connection =  DataBase.getConnection();
			String sql="update roomtypeandprice set price='"+newprice+"' where roomType='"+roomType+"'";
			System.out.println(sql);
			preparedStatement=connection.createStatement();
			preparedStatement.execute(sql);
	...
	public static void checkOutRoom(String orderNumber){
		...
		ResultSet resultSet = null;
		try {
			String roomid =  getOrderById(orderNumber).getRoomNumber();
			updateRoomState(roomid, "空");
			connection =  DataBase.getConnection();
			String sql ="update orders set orderStatus='已退房' where orderNumber='"+orderNumber+"'" ;
			preparedStatement = connection.prepareStatement(sql);
			preparedStatement.execute();
	...
	public static Order getOrder(String roomid){
		...
		try {
			connection =  DataBase.getConnection();
			String sql ="select * from orders where roomNumber='"+roomid+"' and (orderStatus='已入住' or orderStatus='已预定')" ;
			preparedStatement = connection.prepareStatement(sql);
			resultSet = preparedStatement.executeQuery();
			if(resultSet.next()){
	...
	public static Order getOrderById(String orderid){
		...
		try {
			connection =  DataBase.getConnection();
			String sql ="select * from orders where orderNumber='"+orderid+"' and orderStatus='已入住'" ;
			preparedStatement = connection.prepareStatement(sql);
			resultSet = preparedStatement.executeQuery();
			if(resultSet.next()){
				return new Order( resultSet.getString("orderNumber"),
	...
	public static void updateRoomState(String roomid,String status){
		Connection connection = null;
		Statement preparedStatement = null;
		try{
			connection =  DataBase.getConnection();
			String sql="update room set roomStatus= '"+status+"' where roomNumber= "+"'"+roomid+"'";
			System.out.println(sql);
			preparedStatement=connection.createStatement();
			preparedStatement.execute(sql);
	...
	public static void insertOrder(Order order) {
		...
		try {
			...
			preparedStatement.execute();
			updateRoomState(order.getRoomNumber(),"非空");
		} catch(Exception exception) {
			exception.printStackTrace();
		}
	}
