...
//    public static final String URL = "jdbc:mysql://localhost:3306/new?autoReconnect=true&useSSL=false&useUnicode=true&charaterEncoding=UTF";
    public static final String URL="jdbc:mysql://www.icodedock.com:3306/m_jdyd?useUnicode=true&characterEncoding=UTF-8&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    //登录时默认使用system用户验证登录名与密码是否正确
    public static  String USERNAME = "m_jdyd";

    public static  String PASSWORD = "m_jdyd";

    public static final String SYSTEMUSERNAME = "m_jdyd";

    public static final String SYSTEMPASSWORD = "m_jdyd";

    public static final String HOTELUSERNAME = "m_jdyd";

    public static final String HOTELPASSWORD = "m_jdyd";
