...
<head>
    ...
    <script >
        function returnMainPage() {
            window.location.href="/roomNewOrder.jsp?op=1" ;
        }
        ...
        function fun4() {
            ...
            //     + "&birthdata=" + birthdata + "&sex=" + sex + "&phonenumber=" + phonenumber + "&time=" + time+"&indate="+indate
            // console.log(url)
                ...
                <div class="ui three column grid" >
                    <%
                        ...
                        for(RoomTypeAndPrice rtp : allRooms){
                            ArrayList<Integer> list = getNumofRoom(rtp.getRoomType());//list[0]空  list[1]非空
                    %>
                    <div class="column">
                        <div class="ui card">
                            <div class="image">
                            ...
                            <a class="ui blue button" href="<%=list.get(0)==0?"":"/m_jdyd/roomNewOrder.jsp?op=2&roomtype="+rtp.getRoomType()%>">
                                ¥<%=rtp.getPrice()%>/天   点击预定
                            </a>
                        </div>
                    </div>
                    ...
                    <form class="ui form" onsubmit="return  fun4(this)" >
                        ...
                        <h4 class="ui dividing header">入住时间</h4>
                        <div class="field">
                            <label>入住时间</label>
                            <div class="two fields">
                                <div class="field">
                                    <input type="date" value="2018-01-01" id="indate" name="indate" placeholder="预计入住时间">
                    ...
                    <div class="ui right floated labeled button" tabindex="0">
                        ...
                        <div class="ui right button">
                            <%
                                System.out.println("roomNewOrder,request.getQueryString");
