...
<div class="ui inverted menu">
    ...
    <div class="ui simple dropdown item">
        ...
        <div class="menu">
          <!--  <a class="item" href="/roomNewOrder.jsp?op=1"><i class="arrow right icon"></i>订房</a> --> 
            <a class="item" href="/roomOrder.jsp?op=1"><i class="arrow right icon"></i>住房</a>
    ...
    <div class="ui simple dropdown item">
        ...
        <div class="menu">
            ...
            <a class="item" href="/roomManagement/roomPriceManage.jsp?op=2"><i class="edit icon"></i>房间价格管理 </a>
        </div>
    </div>
    <div class="ui simple dropdown item">
